...
botonCancelar.addEventListener('click', function () {
    if (formCambiado) {
        Swal.fire({
            title: '¿Estás seguro?',
            text: 'Los datos que hayas ingresado se eliminarán y regresarás a la ventana "Devolución por Defectos".',
            type: 'question',
        ...
        Swal.fire({
            title: '¿Estás seguro?',
            text: 'Regresarás a la ventana "Devolución por Defectos".',
            type: 'question',
            showCancelButton: true,
            confirmButtonText: 'Aceptar',
            cancelButtonText: 'Cancelar',
