                            ...
                            <div class="Productos-group">
                                ...
                                <div class="añadir_producto-form">
                                    ...
                                    <div class="totalPagar">
                                        ...
                                        <input type="number" name="totalPagar" class="login_nombreUsuario" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="añadir_cliente-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombreCliente" id="nombreCliente"
                                            class="login_nombreUsuario" required oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '');">
                                    </div>
                                    <div class="form-group">
                                        <p class="titulos_form">Cedula </p>
                                        <input type="text" name="cedulaCliente" id="cedulaCliente"
                                            class="login_nombreUsuario" required oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Telefono" class="login_nombreUsuario" required oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    </div>
                                </div>
