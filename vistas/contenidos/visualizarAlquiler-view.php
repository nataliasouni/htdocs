                ...
                <div class="tile-container">
                    <div class="choose-option">
                        ...
                        <div class="choose-option">
                            ...
                            <form class="formularioAjax content" action="<?php echo SERVERURL; ?>ajax/alquilerAjax.php" method="POST" data-form="update" id="formularioContrato">
                            <input type="hidden" name="alquilerUpdate" value="<?= $pagina[1] ?>">
                                <div class="añadir_alquiler-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tiempoAlquiler" id="tiempoAlquiler"
                                            class="login_nombreUsuario" value="<?= $campos['tiempodias'] ?>" readonly
                                            readonly>
                                    ...
                                    <div class="añadir_producto-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombreProducto" id="nombreProducto"
                                                class="login_password" value="<?= $campos['nombre_producto'] ?>" readonly
