    ...
    <section class="full-box page-content">
        ...
        <div class="card-homepage">
            ...
            <div class="card-contenthomepage">
                <div class="card-detailshomepage">
                    <h2 class="card-titlehomepage">Ayudas de movilidad y recuperación en venta alquiler mantenimiento y
                        reparación</h2>
                    ...
                    <p class="card-descriptionhomepage">
                    ...
                    <div class="contentBoton">
                        ...
                        ?>
                        <a data-categoria="movilidad" type="button" style="text-align: center;"
                            href="<?= SERVERURL; ?>productosHome?variable=<?php echo $var; ?>" class="botonesCatalogo">
                            ...
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="large-box">
                ...
                <img class="img-foto" src="<?php echo SERVERURL; ?>vistas/img/diana.jpg" alt="Imagen Diana"></img>
