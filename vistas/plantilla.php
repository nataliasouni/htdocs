...
<body>
  ...
  if ($vistas == "homePage" || $vistas == "404" || $vistas == "login" || $vistas == "agendarCita" || $vistas == "registroCliente" || $vistas == "recuperarContra"|| $vistas = "productosHome") {
    if ($vistas == "homePage" || $vistas == "login" || $vistas == "agendarCita" || $vistas == "registroCliente" || $vistas == "recuperarContra" || $vistas = "productosHome") {
