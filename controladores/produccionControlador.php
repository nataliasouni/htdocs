...
public function generarTablaProduccion()
{
    ...
    if ($total >= 1) {
        ...
        foreach ($datos as $fila) {
            ...
            $tabla .= '<td>
                <button onclick="window.location.href = \'' . SERVERURL . 'editarProduccion/' .
                    mainModel::encryption($fila['id']) . '\';" class="estado-editar button_js btn-editar" 
                type="button" title="Editar" name="Editar"> 
                <img src="./vistas/img/editar.png"></img>
                </button>
                <button onclick="window.location.href = \'' . SERVERURL . 'detallesProduccion/' .
                    mainModel::encryption($fila['id']) . '\';" class="estado-detalles button_js btn-detalles" 
